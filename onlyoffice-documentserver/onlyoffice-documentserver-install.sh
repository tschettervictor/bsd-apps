...
ONLYOFFICE_JWT_SECRET=$(pwgen -s 20)
...
# Add JWT Secret
/usr/local/www/onlyoffice/documentserver/npm/json -q -f /usr/local/etc/onlyoffice/documentserver/local.json -I -e 'this.services.CoAuthoring.secret.inbox.string= "'${ONLYOFFICE_JWT_SECRET}'"'
/usr/local/www/onlyoffice/documentserver/npm/json -q -f /usr/local/etc/onlyoffice/documentserver/local.json -I -e 'this.services.CoAuthoring.secret.outbox.string= "'${ONLYOFFICE_JWT_SECRET}'"'
/usr/local/www/onlyoffice/documentserver/npm/json -q -f /usr/local/etc/onlyoffice/documentserver/local.json -I -e 'this.services.CoAuthoring.secret.session.string= "'${ONLYOFFICE_JWT_SECRET}'"'
...
echo "JWT secret is ${ONLYOFFICE_JWT_SECRET}." >> /root/${APP_NAME}_db_password.txt
...
echo "JWT Secret: "$ONLYOFFICE_JWT_SECRET""
echo "---------------"
