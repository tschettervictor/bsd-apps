...
```
fetch https://raw.githubusercontent.com/tschettervictor/bsd-apps/master/slskd/slskd-install.sh
```
...
FREEBSD_VERSION
- freebsd version to use for dotnet (currently defaults to 14)
